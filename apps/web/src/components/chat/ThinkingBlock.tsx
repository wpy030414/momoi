...
import type { ThinkingSegment } from '@momoi/shared/thinking'
import { decodeThinkingToSegments, isThinkingTruncated } from '@momoi/shared/thinking'
import { THINKING_TRUNCATED_MARK } from '@momoi/shared/constants'
