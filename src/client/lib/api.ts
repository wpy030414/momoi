...
export const api = {
  ...
  // App config
  getAppName: () => request<{ app_name: string; app_favicon: string; app_background: string; support_attachments: boolean; support_infinite_mode: boolean; show_github: boolean; use_external_image_hosting: boolean; recommended_questions: string[]; agents: Array<{ id: string; name: string; avatar: string }> }>('/api/app-name'),
